...
int main(int argc, char *argv[]) try{
    ...
    for(const auto& x:vevsymmetricSolution) absvevsymmetricSolution+=std::pow(x,2);
    ...
    p.init(args.vw,EWPT.EWMinimum,vevsymmetricSolution,EWPT.Tc,modelPointer,args.WhichMinimizer);
