...
{   
    ...
    */
    ...
    //BOTTOM quark mass can be set to zero to have a crosscheck 
        ...
        if((bot_mass_flag!=1)and(bot_mass_flag!=2)) throw std::runtime_error("No valid option for the bottom mass @ ()");
    ...
    //Rescaled chemical potential like in 1811.11104
        ...
        double mu_Y_b   =   omega[2]/kappa_bR - omega[0]/kappa_q - omega[3]/kappa_H_0 - omega[4]/kappa_H_0;
        double mu_SS    =   -4*omega[5] *(2/kappa_QL_0 + 1/kappa_QR_0) + 2*omega[0]/kappa_q - omega[1]/kappa_tR - omega[2]/kappa_bR;
        ...
        */
        ...
        domega[6]   = (vw*omega[6]  - (  Gam_M_t*mu_M_t + Gam_M_b*mu_M_b + Gam_Y_t*mu_Y_t + Gam_Y_b * mu_Y_b - 2*Gam_SS*mu_SS - Scp_t-Scp_b))/Dq;
        domega[7]   = (vw*omega[7]  - (- Gam_M_t*mu_M_t - Gam_Y_t*mu_Y_t + Gam_SS*mu_SS + Scp_t ) )/ Dq;
        domega[8]   = (vw*omega[8]  - (- Gam_M_b*mu_M_b - Gam_Y_b*mu_Y_b + Gam_SS*mu_SS + Scp_b))/Dq;
