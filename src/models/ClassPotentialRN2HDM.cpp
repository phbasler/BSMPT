 ...
 */
std::vector<std::string>  Class_Potential_RN2HDM::addLegendTripleCouplings() const{
...
void Class_Potential_RN2HDM::ReadAndSet(const std::string& linestr, std::vector<double>& par )
{
    ...
    double tmp;
    double lu3 = 0,ll1= 0,ll2=0,ll3=0,ll4=0,
            ll5=0,ll6=0,ll7=0,ll8=0,lvs=0,ltanbeta=0;
    double ltype=0;
...
//    NDTS = VSol[14];
    ...
    for(const auto& x: VSol) parCT.push_back(x);
...
double Class_Potential_RN2HDM::VTreeSimplified(const std::vector<double>& v) const{
    (void) v;
    double res = 0;
...
double Class_Potential_RN2HDM::VCounterSimplified(const std::vector<double>& v) const
{
    (void) v;
...
void Class_Potential_RN2HDM::Debugging(const std::vector<double>& input, std::vector<double>& output) const{
    (void) input;
    (void) output;
