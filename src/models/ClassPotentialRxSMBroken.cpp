 ...
 */
Class_Potential_RxSMBroken::Class_Potential_RxSMBroken(const ISMConstants &smConstants)
...
Class_Potential_RxSMBroken::~Class_Potential_RxSMBroken()
{
}
 ...
 */
std::vector<std::string> Class_Potential_RxSMBroken::addLegendCT() const
{
 ...
 * input file
 */
std::vector<std::string> Class_Potential_RxSMBroken::addLegendTemp() const
{
  std::vector<std::string> labels;
 ...
 *
 */
std::vector<std::string> Class_Potential_RxSMBroken::addLegendTripleCouplings() const
{
  std::vector<std::string> labels;
 ...
 */
std::vector<std::string> Class_Potential_RxSMBroken::addLegendVEV() const
{
  std::vector<std::string> labels;
  // out = "Your VEV order";
  labels.push_back("omega");
 ...
 */
void Class_Potential_RxSMBroken::ReadAndSet(const std::string &linestr,
 ...
 */
void Class_Potential_RxSMBroken::set_gen(const std::vector<double> &par)
{
 ...
 */
void Class_Potential_RxSMBroken::set_CT_Pot_Par(const std::vector<double> &par)
{
 ...
 */
void Class_Potential_RxSMBroken::write() const
{
 ...
 */
std::vector<double> Class_Potential_RxSMBroken::calc_CT() const
{
...
void Class_Potential_RxSMBroken::TripleHiggsCouplings()
{
  if (!SetCurvatureDone) SetCurvatureArrays();
...
void Class_Potential_RxSMBroken::SetCurvatureArrays()
{
  /*
...
bool Class_Potential_RxSMBroken::CalculateDebyeSimplified()
{
  return false;
  /*
...
bool Class_Potential_RxSMBroken::CalculateDebyeGaugeSimplified()
{
  /*
...
double Class_Potential_RxSMBroken::VTreeSimplified(const std::vector<double> &v) const
{
...
double Class_Potential_RxSMBroken::VCounterSimplified(const std::vector<double> &v) const
{
...
void Class_Potential_RxSMBroken::Debugging(const std::vector<double> &input,
