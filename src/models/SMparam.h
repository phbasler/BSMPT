...
const std::complex<double> C_Vcd = s12*c23-c12*s23*s13*exp(imagNumber*delta);
const std::complex<double> C_Vcs = -c12*c23-s12*s23*s13*exp(imagNumber*delta);
const std::complex<double> C_Vtd = s12*s23-c12*c23*s13*exp(imagNumber*delta);
const std::complex<double> C_Vts = -c12*s23-s12*c23*s13*exp(imagNumber*delta);
