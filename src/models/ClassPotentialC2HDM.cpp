...
void Class_Potential_C2HDM::AdjustRotationMatrix()
{
  ...
  if (pos_G0 == -1 or pos_G1 == -1 or pos_G2 == -1 or pos_H1 == -1 or
      pos_H2 == -1 or pos_h1 == -1 or pos_h2 == -1 or pos_h3 == -1)
  {
  ...
  for (std::size_t i = 0; i < NHiggs; i++)
  {
    for (std::size_t j = 0; j < NHiggs; j++)
    {
      ...
      if (not((jj == pos_rho1 and (ii == pos_G1 or ii == pos_H1)) or
              ...
              (jj == pos_psi1 and (ii == pos_G0 or ii == pos_h1 or
                                   ii == pos_h2 or ii == pos_h3)) or
              (jj == pos_psi2 and (ii == pos_G0 or ii == pos_h1 or
                                   ii == pos_h2 or ii == pos_h3)) or
              (jj == pos_zeta1 and
  ...
  // G^0, rho1, eta1, rho2, eta2, zeta1, zeta2, zeta3
  int pos_si_G0 = 0, pos_si_rho1 = 1, pos_si_eta1 = 2, pos_si_rho2 = 3,
      pos_si_eta2 = 4, pos_si_zeta1 = 5, pos_si_zeta2 = 6, pos_si_zeta3 = 7;
  ...
  // Check if all position indices are set
  if (pos_si_G1 == -1 or pos_si_G2 == -1 or pos_si_H1 == -1 or
      pos_si_H2 == -1 or pos_si_h1 == -1 or pos_si_h2 == -1 or pos_si_h3 == -1)
  {
    throw std::runtime_error("Error. Not all position indices are set.");
  }
  ...
  for (std::size_t i = 1; i < NHiggs; i++)
  {
    for (std::size_t j = 1; j < NHiggs; j++)
    {
      ...
      if (not((jj == pos_si_rho1 and (ii == pos_si_G1 or ii == pos_si_H1)) or
              ...
              (jj == pos_si_zeta1 and
               (ii == pos_si_h1 or ii == pos_si_h2 or ii == pos_si_h3)) or
              (jj == pos_si_zeta2 and
               (ii == pos_si_h1 or ii == pos_si_h2 or ii == pos_si_h3)) or
              (jj == pos_si_zeta3 and
               (ii == pos_si_h1 or ii == pos_si_h2 or ii == pos_si_h3))))
      {
        zero_element = true;
      }
