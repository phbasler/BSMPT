...
/**
 * @brief The Class_Potential_RxSMBroken class
 * Template for implementing a new model
 */
class Class_Potential_RxSMBroken : public Class_Potential_Origin
{
public:
  Class_Potential_RxSMBroken(const ISMConstants &smConstants);
  virtual ~Class_Potential_RxSMBroken();
