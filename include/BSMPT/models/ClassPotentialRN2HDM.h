 ...
 *
 * * \f$ -L_S = u1 \Phi_1^\dagger \Phi_1 + u2 \Phi_2^\dagger \Phi_2 + \frac{L1}{2} (\Phi_1^\dagger \Phi_1)^2 + \frac{L2}{2} (\Phi_2^\dagger \Phi_2)^2 + L3 \Phi_1^\dagger \Phi_1 \Phi_2^\dagger \Phi_2 + L4 \Phi_1^\dagger \Phi_2 \Phi_2^\dagger \Phi_1 + [ \frac{RL5}{2} (\Phi_1^\dagger \Phi_2)^2 - RealMMix \Phi_1^\dagger \Phi_2 ] + Nus/2 S^2 + NL6/8 S^4 + NL7/2 \Phi_1^\dagger \Phi_1 S^2 + NL8/2 \Phi_2^\dagger \Phi_2 S^2 \f$
 ...
 * with
 *
 * * \f$ \Phi_1 = \begin{pmatrix} \Phi_1^+ \\  \Phi_1^0 \end{pmatrix} = 1/\sqrt{2} \begin{pmatrix} higgsbase[0] + I*higgsbase[2] \\  higgsbase[6] + I *higgsbase[4] \end{pmatrix}\,, \f$
 * * \f$ \Phi_2 = \begin{pmatrix} \Phi_2^+ \\  \Phi_2^0 \end{pmatrix} = 1/\sqrt{2} \begin{pmatrix} higgsbase[1] + I*higgsbase[3] \\  higgsbase[7] + I *higgsbase[5] \end{pmatrix}  \f$
 * * \f$ S = higgsbase[8] \f$
