...
/**
 * @file
 * These functions use the gsl_interp2d_bicubic interpolation routine from GSL
 * to calculate the K-functions defined in arXiv:hep-ph/0604159v2 Eq. (23).
 * These are needed in the transport equations which are implemented in
 * transport_equations. For this a the integrals (without their normalisation)
 * were evaluated numerically in a grid and stored in the header
 * Kfunctions_grid.h
 */
