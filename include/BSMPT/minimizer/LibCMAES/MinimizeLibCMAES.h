 ...
 * @param params PointerContainerMinPlane with the model information and potential
 * @param Start starting point for the algorithm
 * @return A LibCMAESReturn struct with the CMAES run_status and the candidate for the global minimum
 */
LibCMAESReturn CMAES_Minimize_Plane_gen_all(const struct PointerContainerMinPlane& params,
