 ...
 */
        ...
        public:
            int bot_mass_flag;
            int tau_mass_flag = 1; //Changing to zero for massless tau leptons --> might cause problems!
            /**
        ...
        */
         ...
         */
            ...
            /**
         * @brief Right-handed thermal mass of the top quark as defined in Eq (97,98) in 1910.11794
         * 
         */
            double msqrt_thermal_top;
            /**
         * @brief The difference of the right-handed thermal top quark mass minus the left-handed quark mass defined as in Eq(97,98) in 1910.11794
         * 
         */
            double dmsqrt_thermal_top;
            /**
         * @brief Right-handed thermal mass of the bot quark as defined in Eq (97,98) in 1910.11794
         * 
         */
            double msqrt_thermal_bot;
            /**
         * @brief The difference of the right-handed thermal bot quark mass minus the left-handed quark mass defined as in Eq(97,98) in 1910.11794
         * 
         */
            double dmsqrt_thermal_bot;
            /**
         * @brief Right-handed thermal mass of the tau lepton as defined in Eq (97,98) in 1910.11794
         * 
         */
            double msqrt_thermal_tau;
            /**
         * @brief The difference of the right-handed thermal tau lepton mass minus the left-handed lepton mass defined as in Eq(97,98) in 1910.11794
         * 
         */
