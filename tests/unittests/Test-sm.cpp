...
TEST_CASE("Checking NLOVEV for SM", "[SM]")
{
...
TEST_CASE("Checking EWPT for SM", "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
  std::shared_ptr<BSMPT::Class_Potential_Origin> modelPointer =
...
TEST_CASE("Checking number of CT parameters for SM", "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
  std::shared_ptr<BSMPT::Class_Potential_Origin> modelPointer =
...
TEST_CASE("Checking number of VEV labels for SM", "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
  std::shared_ptr<BSMPT::Class_Potential_Origin> modelPointer =
...
TEST_CASE("Checking number of labels for temperature dependend results for SM",
          "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
...
TEST_CASE("Checking number of triple Higgs couplings for SM", "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
  std::shared_ptr<BSMPT::Class_Potential_Origin> modelPointer =
...
TEST_CASE("Checking Gauge Boson masses for SM", "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
  std::shared_ptr<BSMPT::Class_Potential_Origin> modelPointer =
...
TEST_CASE("Checking fermion and quark masses masses for SM", "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
  std::shared_ptr<BSMPT::Class_Potential_Origin> modelPointer =
...
TEST_CASE("Checking tree level minimum for SM", "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
  std::shared_ptr<BSMPT::Class_Potential_Origin> modelPointer =
...
TEST_CASE("Checking tree level tadpoles for SM", "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
  std::shared_ptr<BSMPT::Class_Potential_Origin> modelPointer =
...
TEST_CASE("Checking NLO masses matching tree level masses for SM", "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
  std::shared_ptr<BSMPT::Class_Potential_Origin> modelPointer =
...
TEST_CASE("Checking VTreeSimplified for SM", "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
  std::shared_ptr<BSMPT::Class_Potential_Origin> modelPointer =
...
TEST_CASE("Checking VCounterSimplified for SM", "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
  std::shared_ptr<BSMPT::Class_Potential_Origin> modelPointer =
...
TEST_CASE("Checking first derivative of the sum of CT and CW in the SM", "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
  std::shared_ptr<BSMPT::Class_Potential_Origin> modelPointer =
...
TEST_CASE("Checking second derivative of the sum of CT and CW in the SM",
          "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
...
TEST_CASE("Checking the identities required to vanish for the CT in the SM",
          "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
...
TEST_CASE("Checking triple higgs NLO couplings in the SM", "[SM]")
{
...
TEST_CASE("Check number of calculated CT parameters in the SM", "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
  std::shared_ptr<BSMPT::Class_Potential_Origin> modelPointer =
...
TEST_CASE("Check symmetric properties of the scalar tensor Lij in the SM",
          "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
...
TEST_CASE("Check symmetric properties of the scalar tensor Lijk in the SM",
          "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
...
TEST_CASE("Check symmetric properties of the scalar tensor Lijkl in the SM",
          "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
...
TEST_CASE("Check symmetric properties of the gauge tensor in the SM", "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
  std::shared_ptr<BSMPT::Class_Potential_Origin> modelPointer =
...
TEST_CASE("Check symmetric properties of the Lepton tensor in the SM", "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
  std::shared_ptr<BSMPT::Class_Potential_Origin> modelPointer =
...
TEST_CASE("Check symmetric properties of the mass Lepton tensor in the SM",
          "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
...
TEST_CASE("Check symmetric properties of the mass quark tensor in the SM",
          "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
...
TEST_CASE("Check symmetric properties of the quark tensor in the SM", "[SM]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
  std::shared_ptr<BSMPT::Class_Potential_Origin> modelPointer =
