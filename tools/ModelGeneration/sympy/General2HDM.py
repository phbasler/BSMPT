...
#doublets
phi1 = Matrix([[Higgsfields[0]+I*Higgsfields[1]], [Higgsfields[4]+I*Higgsfields[5]]]) * 1/sqrt(2)
phi2 = Matrix([[Higgsfields[2]+I*Higgsfields[3]], [Higgsfields[6]+I*Higgsfields[7]]]) * 1/sqrt(2)
...
VGauge = simplify(Dagger(Dmu*phi1)*(Dmu*phi1))[0,0] + simplify(Dagger(Dmu*phi2)*(Dmu*phi2))[0,0]
